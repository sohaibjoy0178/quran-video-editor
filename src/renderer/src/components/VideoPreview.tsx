...
export function VideoPreview() {
    ...
    }, [volume, isMuted, audioPath, videoPath])
    ...
    }, [audioPath, masterDuration, setCurrentTime, setIsPlaying])
    ...
    useEffect(() => {
        ...
        const drawCaptions = () => {
            ...
            for (const cap of active) {
                ...
                const baseDur =
                    animName === 'cinematic' ? 1.8 : animName === 'typewriter' || animName === 'pop-in' ? 0.3 : 0.7
    ...
    }, [captions, captionStyle, previewSize, audioPath, wrapText, fontsReady])
        ...
        <div className="preview" ref={containerRef}>
            ...
            >
                <video
                    ...
                    playsInline
                    preload="auto"
                    style={{ width: '100%', height: '100%', objectFit: 'contain', filter: previewVideoFilter }}
                />
                ...
                {metadata?.surah && (
                    ...
                    >
                        ...
                        <div className="preview__surah-info">
                            ...
                            {metadata.verses && (
                                <span className="preview__surah-verses">
                                    Ayah {metadata.verses}
                                </span>
                            )}
                        </div>
                    </div>

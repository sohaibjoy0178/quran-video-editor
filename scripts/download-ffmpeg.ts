import { createWriteStream, mkdirSync, existsSync, renameSync, rmSync, unlinkSync } from 'fs'
...
async function downloadFile(url: string, dest: string): Promise<unknown> {
...
;(async () => {
  ...
  try {
    ...
    if (existsSync(ffprobePath)) {
      renameSync(ffprobePath, destProbe)
